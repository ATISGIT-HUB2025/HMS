...
jQuery(document).on('click', '.iq-full-screen', function() {
    if (!document.fullscreenElement &&
        ...
        document.querySelector('.iq-full-screen2').querySelector('.normal-screen').classList.add('d-none');
        document.querySelector('.iq-full-screen2').querySelector('.full-normal-screen').classList.remove('d-none');
    } else {
        ...
        document.querySelector('.iq-full-screen2').querySelector('.full-normal-screen').classList.add('d-none');
        document.querySelector('.iq-full-screen2').querySelector('.normal-screen').classList.remove('d-none');
    }
});
